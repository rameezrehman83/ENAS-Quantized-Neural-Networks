...
# ----- Experiment Settings -----
DEFINE_string("output_dir", "./output-cifar-arc" , "")
...
DEFINE_integer("num_epochs",5," = (10 + 20 + 40 + 80 + 160 +320)")
...
def train():
    ...
    print("shape images", images['train'].shape)
    print("shape labels", labels['train'].shape)
